...
import com.pedro_bruno.areader.components.RoundedButton
...
fun ShowBookDetails(bookInfo: Resource<Item>, navController: NavController) {
    ...
    Text(text = "Published: ${bookData.publishedDate}", style = MaterialTheme.typography.subtitle1)
            ...
            .addOnSuccessListener { documentRef ->
                ...
                dbCollection.document(docId)
                    ...
                    .addOnCompleteListener { task ->
                        ...
                        Log.d("saveToFirebase", "saveToFirebase: Error updating doc")
                    }
            }
    } else {
